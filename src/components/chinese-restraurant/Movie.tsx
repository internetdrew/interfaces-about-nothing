...
export default function Movie({ onBack, onLeaveQueue }: MovieProps) {
  return (
    <div className="flow-root w-88 text-white">
      ...
      <p className="mx-4 mt-4 mb-6 rounded-xl bg-[#250b08] p-3 text-xs leading-relaxed text-pretty text-[#ff9b90]">
        <span className="text-white">Probably not.</span> <br />
        With a 12-minute trip, you’d have about 6 minutes to eat.
      </p>
      <div className="mx-4 mb-4 flex gap-2">
        ...
        <HoldToLeaveButton onConfirm={onLeaveQueue} />
      </div>
    </div>
  );
}
import HoldToLeaveButton from "./HoldToLeaveButton";
